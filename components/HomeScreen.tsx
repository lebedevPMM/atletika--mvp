...
import { HomeScreenNeon } from './HomeScreenNeon';
import { HomeScreenPastel } from './HomeScreenPastel';
...
const HomeScreen: React.FC<HomeScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {brandTheme === 'pastel' && <HomeScreenPastel onNavigate={onNavigate} toggleBrandTheme={toggleBrandTheme} brandTheme={brandTheme} />}
