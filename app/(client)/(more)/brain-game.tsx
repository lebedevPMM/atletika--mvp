...
export default function BrainGameScreen() {
  useScreenView('client_brain_game');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Мини-игра</Text>
      </View>
      <ComingSoon icon="🧩" title="Мини-игра" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
