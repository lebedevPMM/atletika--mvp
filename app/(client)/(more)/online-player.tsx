...
export default function OnlinePlayerScreen() {
  useScreenView('client_online_player');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Онлайн-проигрыватель</Text>
      </View>
      <ComingSoon icon="▶️" title="Онлайн-проигрыватель" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
