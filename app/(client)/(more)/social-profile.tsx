...
export default function SocialProfileScreen() {
  useScreenView('client_social_profile');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Социальный профиль</Text>
      </View>
      <ComingSoon icon="👤" title="Социальный профиль" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
