...
export default function TrainerEducationScreen() {
  useScreenView('trainer_education');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ComingSoon icon="🎓" title="Обучение" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
