...
export default function TrainerReplacementScreen() {
  useScreenView('trainer_replacement');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Замена тренера</Text>
      </View>
      <ComingSoon icon="🔄" title="Замена тренера" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
