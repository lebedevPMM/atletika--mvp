...
export default function ExerciseLibraryScreen() {
  useScreenView('trainer_exercise_library');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Библиотека упражнений</Text>
      </View>
      <ComingSoon icon="📚" title="Библиотека упражнений" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
