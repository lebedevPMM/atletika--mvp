...
export default function TrainerBroadcastScreen() {
  useScreenView('trainer_broadcast');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ComingSoon icon="📢" title="Рассылка" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
