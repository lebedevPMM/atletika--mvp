...
export default function TrainerCommunityScreen() {
  useScreenView('trainer_community');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Сообщество тренеров</Text>
      </View>
      <ComingSoon icon="🤝" title="Сообщество тренеров" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
