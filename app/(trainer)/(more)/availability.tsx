...
export default function TrainerAvailabilityScreen() {
  useScreenView('trainer_availability');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Доступность</Text>
      </View>
      <ComingSoon icon="📅" title="Доступность" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
