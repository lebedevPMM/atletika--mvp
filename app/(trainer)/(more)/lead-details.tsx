...
export default function LeadDetailsScreen() {
  useScreenView('trainer_lead_details');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Детали лида</Text>
      </View>
      <ComingSoon icon="🎯" title="Детали лида" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
