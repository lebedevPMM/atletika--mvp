...
export default function PayrollHistoryScreen() {
  useScreenView('trainer_payroll_history');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>История зарплат</Text>
      </View>
      <ComingSoon icon="📈" title="История зарплат" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
