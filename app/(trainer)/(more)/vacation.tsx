...
export default function TrainerVacationScreen() {
  useScreenView('trainer_vacation');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Отпуск</Text>
      </View>
      <ComingSoon icon="🏖" title="Отпуск" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
