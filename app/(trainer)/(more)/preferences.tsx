...
export default function TrainerPreferencesScreen() {
  useScreenView('trainer_preferences');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ComingSoon icon="⚙️" title="Предпочтения" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
