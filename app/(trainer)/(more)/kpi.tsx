...
export default function TrainerKpiScreen() {
  useScreenView('trainer_kpi');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>KPI</Text>
      </View>
      <ComingSoon icon="📊" title="KPI" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
