...
export default function TrainerCertificationScreen() {
  useScreenView('trainer_certification');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Сертификация</Text>
      </View>
      <ComingSoon icon="🎓" title="Сертификация" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
