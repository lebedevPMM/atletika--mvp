...
export default function EquipmentReportScreen() {
  useScreenView('trainer_equipment_report');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Оборудование</Text>
      </View>
      <ComingSoon icon="🔧" title="Оборудование" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
