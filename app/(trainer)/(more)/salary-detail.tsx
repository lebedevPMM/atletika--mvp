...
export default function SalaryDetailScreen() {
  useScreenView('trainer_salary_detail');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Детали зарплаты</Text>
      </View>
      <ComingSoon icon="💳" title="Детали зарплаты" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
