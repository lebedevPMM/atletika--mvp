...
export default function ClientAssessmentScreen() {
  useScreenView('trainer_client_assessment');
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Оценка клиента</Text>
      </View>
      <ComingSoon icon="📋" title="Оценка клиента" description="Этот раздел скоро будет доступен" />
    </SafeAreaView>
  );
}
